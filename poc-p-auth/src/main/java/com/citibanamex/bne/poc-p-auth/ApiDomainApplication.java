...
import com.citibanamex.bne.poc-p-auth.errorhandling.exception.MicroserviceClientException;
...
public class ApiDomainApplication {
	...
	public Docket productApi() {
		return new Docket(DocumentationType.SWAGGER_2).
				...
				.apis(RequestHandlerSelectors.basePackage("com.citibanamex.bne.poc-p-auth.api"))
